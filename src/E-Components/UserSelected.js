                    ...
                    {this.props.favPaintData.map(item => (
                        ...
                        <div className="wrapper2">
                            <div className="container2">
                                ...
                                <br></br>
                                <Button className='deleteFavCard2' variant="primary" onClick={() => this.props.deleteFavItemFun(item._id)}>Remove</Button>


                            </div>
                            <div className="inside2">
                                <div className="icon2"><i className="material-icons2">i</i></div>
